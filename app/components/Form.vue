...
<template>
    <section class="w-full relative px-10 h-auto mb-5 font-roman lg:mt-56 mt-10">
        <form @submit.prevent="handleSubmit" class="grid pt-5 w-full lg:pl-16 max-w-4xl gap-5 mx-auto grid-cols-1">
            ...
            <div class="grid lg:grid-cols-2 gap-5">
                ...
                <!-- PHONE -->
                <Select v-model="form.phone" v-model:code="form.code" codeName="code" phoneName="phone" :error="!!errors.phone" />
            </div>
