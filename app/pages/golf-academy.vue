<script setup>
    ...
    import bgImage from '../assets/images/banner/banner.webp'
...
<template>
  ...
  <div aria-label="hero-banner" class="flex justify-center items-center w-full h-screen overflow-hidden" :style="heroStyle" >
    <div class="z-30 text-center mt-28">
      ...
      <!-- Social -->
      <div class="mt-10">
        <h2 class="text-darkCyan lg:text-2xl text-lg font-roman mb-4">
          FOLLOW US FOR MORE
        </h2>
        ...
        <div class="flex gap-5 justify-center items-center">
            ...
            <div class="bg-amber w-7 h-7 mt-1 flex justify-center items-center rounded-full">
                <a href="https://www.facebook.com/chhunongolfresort" class="absolute mt-2 pt-[3px]" target="_blank" aria-label="social" aria-labelledby="social">
                    <svg width="20" height="25" fill="#fff" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 50 50">
            ...
            <!--- Instagram svg --->
            <div class="w-8 h-8 text-amber flex justify-center items-center rounded-full">
                <a href="https://www.instagram.com/chhunongolfresort/" target="_blank" aria-label="social">
                    <svg width="23" height="23" viewBox="0 0 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                        <g>
          ...
          <!-- LinkedIn -->
          <a
            href="https://www.linkedin.com/company/chhunongolfresort/"
            target="_blank"
            class="bg-amber w-6 h-6 flex justify-center items-center rounded-md"
          >
          ...
          <!-- Telegram -->
          <a
            href="https://t.me/chhunongolfresort"
            target="_blank"
            class="text-amber"
          >
            <svg width="30" height="30" viewBox="0 0 24 24" fill="none">
              <path
                d="M21 5L2 12.5L9 13.5M21 5L18.5 20L9 13.5M9 13.5V19L12.25 15.72"
                stroke="currentColor"
                stroke-width="1.5"
