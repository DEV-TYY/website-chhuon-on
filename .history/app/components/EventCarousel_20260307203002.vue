...
<div ref="wrapper" class="relative">
  ...
  <!-- Next -->
  <button @click="next" class="absolute translate-x-16 top-80 right-12 z-30 lg:flex hidden items-cemter lg:w-40 w-10 justify-end h-full cursor-pointer group focus:outline-none">
