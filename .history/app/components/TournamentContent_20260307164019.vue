    ...
    <div class="bg-darkCyan lg:w-[60%] w-full px-10 py-10">
      <div class="lg:mt-10 lg:mb-10">
        <p class="text-lg lg:text-2xl text-white text-justify font-roman">
            We would like to extend our heartfelt gratitude to each of you for your participation and support in making the
            City Golf Loyalty Championship a resounding success. Your enthusiasm and commitment were pivotal in bringing together 108 players for this memorable event. A special thank you goes out to our sponsors for their generous
            contributions, which played a crucial role in enhancing the experience for everyone involved. Your support not
            only enriches the tournament but also strengthens our community of golfers.
        </p>
        <p class="text-lg lg:text-2xl text-white text-justify font-roman mt-5">
           We hope you enjoyed the competition and camaraderie as much as we did. We look forward to seeing you at
          future events!
        </p>
      </div>
    </div>
