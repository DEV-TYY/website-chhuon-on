...
<div ref="wrapper" class="relative">
  <!-- Prev -->
  <button @click="prev" class="absolute -translate-x-2.5 top-80 start-0 z-30 lg:flex hidden items-start  w-10 justify-end h-full cursor-pointer group focus:outline-none">
