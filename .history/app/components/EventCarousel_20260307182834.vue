...
const next = () => {
  const firstCardWidth = carousel.value?.querySelector(".card")?.clientWidth || 0
...
<div class="wrapper relative">
    ...
    <!-- LEFT BUTTON -->
    <button id="left"  @click="next" type="button" class="absolute top-80 start-0 z-30 lg:flex hidden items-cemter lg:w-48 w-10 justify-end h-full cursor-pointer group focus:outline-none">
    ...
    <!-- RIGHT BUTTON -->
    <button id="right"  @click="prev" type="button" class="absolute top-80 right-12 z-30 lg:flex hidden items-cemter lg:w-40 w-10 justify-start h-full cursor-pointer group focus:outline-none">
