...
<div class="wrapper relative">
    ...
    <button id="right"
      @click="next"
      type="button" type="button" class="absolute top-80 right-12 z-30 lg:flex hidden items-cemter lg:w-40 w-10 justify-start h-full cursor-pointer group focus:outline-none">
