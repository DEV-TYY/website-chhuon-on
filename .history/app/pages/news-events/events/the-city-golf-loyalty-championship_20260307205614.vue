...
<template>
  <div>
    ...
    <div class="lg:mb-14 w-full h-fit py-8">
        <div class="bg-[#F3F3F3] mb-8 h-fit">
            <div class="w-full text-center lg:py-10 pt-10">
                <h1 class="font-roman lg:text-5xl text-3xl lg:mb-3 mb-0 text-amber">PREVIOUS EVENTS</h1>
                    <Title textClass="text-amber border-none font-roman lg:text-5xl text-3xl lg:mb-3 mb-0 text-amber" title="PREVIOUS EVENTS"/>
